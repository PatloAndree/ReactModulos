...
const BarraBusqueda = ({ onAgregarFila  , setLimpiarForm }) => {
  ...
  useEffect(() => {
    ...
    if (setLimpiarForm === true) {
      limpiarElForm();
    }
  }, [datosTabla, initialData, itemsSeleccionados, setLimpiarForm]);
  ...
  const handleQuantityChange = (index, quantity) => {
    ...
    if (quantity <= itemsSeleccionados[index].stock) {
      ...
      updatedItems[0].montoTotalVenta = calcularTotalConImpuesto();
